...
### Endidau craidd technegol
Mae'r bensaernÃ¯aeth yn gwahanu cysyniadau'n llym i sicrhau cywirdeb data ac osgoi gwallau fel "enw defnyddiwr = dynol":
- **Hunaniaeth a Chyfrifon:** `Person` â‰  `Cyfrif Defnyddiwr` â‰  `Gwirio Hunaniaeth`. Mae person wedi'i ddilysu yn cymryd rhan trwy un cyfrif, ond mae'r endidau'n aros ar wahÃ¢n.
- **Cyfathrebu:** `Neges` â‰  `Cyfieithiad`. Mae'r neges wreiddiol yn ddigyfnewid; Mae cyfieithiadau yn endidau cysylltiedig.
- **Cymedrol:** `Adroddiad` â‰  `Penderfyniad Cymedroli`. Dim ond arwydd yw neges; mae cymedrolwr yn cynnal yr ymchwiliad.
- **Cyllid:** `Rhodd` â‰  `Gweddill y Gronfa`. Mae taliadau'n cael eu postio'n ddigyfnewid i gronfa trwy gyfriflyfr (llyfr arian parod).

### Parthau pwnc cysylltiedig
Rhennir y system yn barthau rhesymegol (cyd-destunau wedi'u ffinio): Hunaniaeth, Cyfrif, Trefniadaeth, Cyfathrebu, Cymuned, Iaith, Cymedroli, Hysbysu, Cyllid a Llywodraethu. Maent yn cynrychioli'r gadwyn gyfan o actorion go iawn (defnyddwyr, ysgolion, cyrff anllywodraethol) i'w rhyngweithiadau digidol.

## Statws prosiect
Mae'r prosiect yn y cyfnod pensaernÃ¯aeth a chynllunio gweithredol.
Mae penderfyniadau pensaernÃ¯ol parhaus yn cael eu dogfennu yn y ffolder `/docs`.

---

## Trwydded ac Eiddo Deallusol

> **Â© 2024-2026 SonnerStudio - Jan Friske Sylfaenydd, Perchennog, Cyfarwyddwr a Phrif Ddylunydd SonnerStudio â€” Cedwir pob hawl.**

**Nexus Gaja** yw eiddo deallusol unigryw **Jan Friske**, sy'n gweithredu o dan **SonnerStudio**.

Jan Friske yw unig greawdwr, pensaer a pherchennog Nexus Gaja - gan gynnwys yr holl gysyniadau, pensaernÃ¯aeth, modelau parth, hunaniaeth brand a dogfennaeth gysylltiedig.

**Ni roddir unrhyw hawliau, trwyddedau na buddiannau perchnogol i unrhyw drydydd parti** waeth beth fo'u maint, safle'r farchnad neu ddylanwad yn y diwydiant technoleg.

### Beth NA chaniateir heb ganiatÃ¢d ysgrifenedig penodol:
- âŒ CopÃ¯o, atgynhyrchu neu ddosbarthu'r feddalwedd hon neu ei dogfennaeth
- âŒ Addasu, addasu neu greu gweithiau deilliadol
- âŒ Defnydd masnachol o unrhyw ran o Nexus Gaja
- âŒ Defnyddio cynnwys ystorfa fel **data hyfforddi ar gyfer systemau AI/LLM**
- âŒ Is-drwyddedu neu drosglwyddo hawliau i drydydd parti

### Eiddo deallusol gwarchodedig
Mae'r cysyniadau gwreiddiol canlynol yn cael eu diogelu fel cyfrinachau masnach a chreadigaethau perchnogol Jan Friske:
- Y model cyfathrebu aml-haenog *(Dehongliad Gwreiddiol / Semantig / Argraffiad Cyfieithedig)*
- Yr egwyddor gwahanu hunaniaeth * (person â‰  cyfrif defnyddiwr â‰  dilysu hunaniaeth)*
- Y model datgysylltu neges-cyfieithu *(cyfieithiad neges â‰ )*
- Y fframwaith llywodraethu cymedroli AI

### Cyswllt
Ar gyfer ymholiadau trwydded: [github.com/SonnerStudio]( https://github.com/SonnerStudio)

* Mae â€œNexus Gajaâ€ a logo Nexus Gaja yn nodau masnach Jan Friske. Gwaherddir defnydd anawdurdodedig o'r enw neu nod masnach.*

âž¡ï¸ Telerau trwydded lawn yn [TRWYDDED] (TRWYDDED)