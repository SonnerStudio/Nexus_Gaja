...
Mae'r bensaernïaeth yn gwahanu cysyniadau'n llym i sicrhau cywirdeb data ac osgoi gwallau fel "enw defnyddiwr = dynol":
- **Hunaniaeth a Chyfrifon:** `Person` ≠ `Cyfrif Defnyddiwr` ≠ `Gwirio Hunaniaeth`. Mae person wedi'i ddilysu yn cymryd rhan trwy un cyfrif, ond mae'r endidau'n aros ar wahân.
- **Cyfathrebu:** `Neges` ≠ `Cyfieithiad`. Mae'r neges wreiddiol yn ddigyfnewid; Mae cyfieithiadau yn endidau cysylltiedig.
- **Cymedrol:** `Adroddiad` ≠ `Penderfyniad Cymedroli`. Dim ond arwydd yw neges; mae cymedrolwr yn cynnal yr ymchwiliad.
- **Cyllid:** `Rhodd` ≠ `Gweddill y Gronfa`. Mae taliadau'n cael eu postio'n ddigyfnewid i gronfa trwy gyfriflyfr (llyfr arian parod).
...
## Statws prosiect
Mae'r prosiect yn y cyfnod pensaernïaeth a chynllunio gweithredol.
Mae penderfyniadau pensaernïol parhaus yn cael eu dogfennu yn y ffolder `/docs`.

---

## Trwydded ac Eiddo Deallusol

> **© 2024-2026 SonnerStudio - Jan Friske Sylfaenydd, Perchennog, Cyfarwyddwr a Phrif Ddylunydd SonnerStudio — Cedwir pob hawl.**

**Nexus Gaja** yw eiddo deallusol unigryw **Jan Friske**, sy'n gweithredu o dan **SonnerStudio**.

Jan Friske yw unig greawdwr, pensaer a pherchennog Nexus Gaja - gan gynnwys yr holl gysyniadau, pensaernïaeth, modelau parth, hunaniaeth brand a dogfennaeth gysylltiedig.
...
### Beth NA chaniateir heb ganiatâd ysgrifenedig penodol:
- ❌ Copïo, atgynhyrchu neu ddosbarthu'r feddalwedd hon neu ei dogfennaeth
- ❌ Addasu, addasu neu greu gweithiau deilliadol
- ❌ Defnydd masnachol o unrhyw ran o Nexus Gaja
- ❌ Defnyddio cynnwys ystorfa fel **data hyfforddi ar gyfer systemau AI/LLM**
- ❌ Is-drwyddedu neu drosglwyddo hawliau i drydydd parti
...
- Yr egwyddor gwahanu hunaniaeth * (person ≠ cyfrif defnyddiwr ≠ dilysu hunaniaeth)*
- Y model datgysylltu neges-cyfieithu *(cyfieithiad neges ≠)*
- Y fframwaith llywodraethu cymedroli AI

### Cyswllt
Ar gyfer ymholiadau trwydded: [github.com/SonnerStudio]( https://github.com/SonnerStudio)

* Mae “Nexus Gaja” a logo Nexus Gaja yn nodau masnach Jan Friske. Gwaherddir defnydd anawdurdodedig o'r enw neu nod masnach.*

➡️ Telerau trwydded lawn yn [TRWYDDED] (TRWYDDED)