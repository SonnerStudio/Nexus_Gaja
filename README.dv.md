...
![ނެކްސަސް ގާޖާ ފައިނޭންސް މޮޑެލް](assets/img/nexus_finance.jpg)

ނެކްސަސް ގާޖާއަށް ވަރަށް މުހިންމު އަސާސީ އިގްތިސާދީ އުސޫލެއް ތަންފީޒު ކުރެވޭ: **ޕްލެޓްފޯމްގެ ތެރޭގައި ކްލާސިކް އިޝްތިހާރެއް ނުކުރުން.**
މިކަމުގެ ސަބަބުން ނެކްސަސް ގާޖާ މިއަދުގެ ގިނަ ސޯޝަލް ނެޓްވޯކްތަކާ ކޮންސެޕްޓިއަލީ ތަފާތުވެގެންދެއެވެ. އެކަމަކު އޭގެ މާނައަކީ: ނެކްސަސް ގާޖާގައި ވިޔަފާރީގެ ކެރެކްޓަރެއް ހުރެގެން ނުވާނެ އެވެ. އެއާ ޚިލާފަށް: ޕްލެޓްފޯމަކީ އިޤްތިޞާދީ ގޮތުން ފައިދާހުރި އެއްޗަކަށް ވާންޖެހެނީ، އޭގެ އިޖުތިމާޢީ މަޤްޞަދު ދިގުމުއްދަތުގައި ދެމިއޮތުމަށްޓަކައެވެ. އެހެންކަމުން އިގްތިސާދީ ހަރަކާތަކީ ނިމުމެއް ހޯދުމަށް ކުރާ ވަސީލަތެއް، ޕްލެޓްފޯމްގެ ހަގީގީ މަގުސަދެއް ނޫނެވެ.

### 1. އުސޫލު NG-FIN-001
ނެކްސަސް ގާޖާ އިން އޮޕަރޭޝަންތައް ފައިނޭންސް ކުރަނީ ޔޫޒަރުންގެ މަސްލަހަތާ ވަކިން ޓްރާންސްޕޭރެންޓް ރެވިއު ސްޓްރީމްތަކެއް މެދުވެރިކޮށް ކަމަށާއި އެއީ ޔޫޒަރުންގެ ސަމާލުކަން ނުވަތަ ޕާސަނަލް ޑޭޓާ މާކެޓް ކުރުމުން ނޫން ކަމަށެވެ.

### 2. ކްލާސިކް އިޝްތިހާރެއް ނެތެވެ
ވަކިން ޚާއްޞަކޮށް ތިރީގައިވާ ކަންތައްތައް ހުއްދައެއް ނުކުރެވޭނެއެވެ.
- ބެނާ އިޝްތިހާރުކުރުން
- ޕޮޕް އަޕް އިޝްތިހާރުކުރުން
- އޮޓޮމެޓިކުން ކުޅެވޭ އިޝްތިހާރު ވީޑިއޯ
- އާންމު ފީޑްގައި ސްޕޮންސަރ ކުރެވިފައިވާ ޕޯސްޓްތައް
- ޕާސަނަލައިޒްޑް އިޝްތިހާރު ޕްރޮފައިލްތައް
- ޔޫޒަރ ޕްރޮފައިލް ވިއްކުން
- ޕާސަނަލް ޑޭޓާ ވިއްކުން
- އަމިއްލަ ވާހަކަތަކުން އުފެދޭ އިޝްތިހާރު.

މިކަމުގެ ސަބަބުން މުވާސަލާތީ ޖާގަ ދޫކޮށްލަނީ: **އިޝްތިހާރު ކުރުމުގެ ޖާގަގެ ބަދަލުގައި މުވާސަލާތީ ޖާގަ.**

### 3. އިޝްތިހާރު ނުކޮށް ފައިނޭންސް ކުރުން
އޭގެ ބަދަލުގައި އަޅުގަނޑުމެންގެ ފައިނޭންސިންގ އެކުލެވިގެންވަނީ އެތައް ތަނބުތަކެއްގެ މައްޗަށް. އަޅުގަނޑުމެން އެންމެ ފުރަތަމަ ހުށަހަޅަނީ ހަ ތަނބެކެވެ:
```ޓެކްސްޓް
                 ނެކްސަސް ގާޖާ އެވެ
                     │
       ┌───────────────────────────┐
       ▼ ▼ ▼
   ޕްރީމިއަމް އޯގަނައިޒޭޝަން ޑޮނޭޓް
       │ │ │ އެވެ
       ├───────────────────────────┤
       ▼ ▼ ▼
   ޕާޓްނަރޝިޕް ސާވިސަސް ޕްރޮމޯޓްކުރުން
```

#### ތަނބު 1 – ހިލޭ އަސާސީ މެމްބަރުކަން
**ނެކްސަސް ގާޖާ ފްރީ:** ބައިނަލްއަޤްވާމީ ވިސްނުމުގައި އަސާސީ ބައިވެރިވުން ބިނާވެފައި އޮންނަންވާނީ މީހެއްގެ އަތުގައި ފައިސާ ހުރިތޯއެވެ. ތިރީގައިވާ ކަންތައްތައް ހިލޭ ކުރެވޭނެ: ޕާސަނަލް ޕްރޮފައިލް، ބައިނަލްއަގްވާމީ މުވާސަލާތު، ކޮންޓްރިބިއުޝަންސް، ކޮމެންޓްސް، އަސާސީ ތަރުޖަމާ، ކޮމިއުނިޓީސް، ޗެޓްސް، އަސާސީ މީޑިއާ ފަންކްޝަންސް.

#### ތަނބު 2 – ޕްރީމިއަމް އޮފާސް
ހިލޭސާބަހަށް ފައިސާ ދައްކާ އޮފާ (**ނެކްސަސް ގާޖާ ޕްލަސް**) އެވެ. ލިބިދާނެ ފައިދާތައް: ސްޓޯރޭޖް ލިމިޓް ބޮޑުވުމާއި، މީޑިއާގެ ފެންވަރު މަތިވުމާއި، ވީޑިއޯ ޓްރާންސްމިޝަން ދިގުވުމާއި، ތަރުޖަމާ ކުރުމުގެ ފަންކްޝަންތައް ފުޅާވުމާއި، ކޮމިއުނިޓީތައް ބޮޑުވުމާއި، އިތުރު އޯގަނައިޒޭޝަނަލް ފަންކްޝަންތަކާއި، އެއައި ކޯޓާ މަތިވުމެވެ.
**ފްރީމިއަމް – އެކަމަކު “ޑާކް ފްރީމިއަމް” ނޫން:** ހިލޭ ވަރޝަން ބުއްދިވެރި ގޮތެއްގައި ބޭނުން ކުރެވިދާނެ؛ ޕްރީމިއަމް އިން އެކަން ފުޅާކުރެއެވެ.

#### ތަނބު 3 – ޖަމިއްޔާތައް
**ނެކްސަސް ގާޖާ އޯގަނައިޒޭޝަން:** ސްކޫލްތަކާއި، ޔުނިވަރސިޓީތަކާއި، ކްލަބްތަކާއި، އެންޖީއޯތަކާއި، ކުންފުނިތަކާއި، މުނިސިޕަލްޓީތަކާއި، ފަދަ ތަންތަނަށް ޚާއްޞަ އެކައުންޓްތައް، ސެންޓްރަލް އޮގަނައިޒޭޝަނަލް އެކައުންޓާއި، މެމްބަރު މެނޭޖްމަންޓާއި، އެޑްމިން ފަންކްޝަންތަކާއެކު. (މިސާލު: ސްކޫލަކަށް ދަރިވަރުންނަށް އެކްސެސް ލިބެނީ ހިލޭ ނުވަތަ އިންސްޓިޓިއުޝަނަލް ޓެރިފް މެދުވެރިކޮށެވެ).

#### ތަނބު 4 – ހަދިޔާތައް
**ނެކްސަސް ގާޖާ ފަންޑިންގ ފަންޑް:** ޑޮނަރުންނަށް ހިލޭސާބަހަށް ފައިސާ ފޯރުކޮށްދެވޭނެ (އާންމު ނުވަތަ ޚާއްޞަ ހަދިޔާ) އެވެ. 
**ފަންޑިންގ ޕޫލާއި ޓޮމްބޯލާ:** ހިލޭ ނުވަތަ ޑިސްކައުންޓްކޮށް ބޭނުންކުރުމަށް ފައިނޭންސް ކުރެވެނީ ޑޮނޭޝަން ޕޫލަކުންނެވެ. ފަންޑު އެލޮކޭޝަން ލެޖަރ އިން އާރމާކިންގ ކަށަވަރުކޮށްދެއެވެ.
```ޓެކްސްޓް
ހަދިޔާ → މަޤްޞަދު ފަންޑު → ޝަރުޠު ހަމަވާ އިންޖީނު → ހިލޭ އެކްސެސް / ޑިސްކައުންޓް / ކޯޓާ
```

#### 5 ވަނަ ތަނބު – މުއައްސަސާތަކުގެ އެހީތެރިކަން
ސްޕޮންސަރުން: ފައުންޑޭޝަންސް، ކަލްޗަރަލް ފަންޑިންގ ޕްރޮގްރާމްސް، ސްޓޭޓް ފަންޑިންގ ޕްރޮގްރާމްސް.
**އެންޖީ-ފިން-002 (މިނިވަންކަން):** ފަންޑިންގ އިން ނެކްސަސް ގާޖާގެ މައްޗަށް އެޑިޓޯރިއަލް ނުވަތަ ޓެކްނިކަލް ކޮންޓްރޯލް ނުގަނެވޭނެއެވެ.

#### ތަނބު 6 – ވިޔަފާރީގެ ހިދުމަތްތައް
ނެކްސަސް ގާޖާ އިން އާންމު ޔޫޒަރ ފީޑަށް އިޝްތިހާރު ކުރުމުން ބުރަ ނުކޮށް **ޓްރާންސްލޭޝަން-އޭޒް-އޭ-ސާވިސް (އޭޕީއައި)**، ޕްރޮފެޝަނަލް ޓްރާންސްލެޝަން، އޮގަނައިޒޭޝަނަލް ކޮމިއުނިކޭޝަން ނުވަތަ އިންޓަނޭޝަނަލް ކޮންފަރެންސް ރޫމް ފަދަ ބީ2ބީ ހިދުމަތްތައް ފޯރުކޮށްދެވޭނެ އެވެ.
