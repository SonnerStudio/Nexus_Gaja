...
`Mesej` → `Mesej Sebelumnya` → `Konteks Benang` → `Konteks Komuniti` → `Bahasa / Wilayah` → `Keutamaan Pengguna`
...
- **Kadar:** “Sebagai contoh, kebarangkalian pelanggaran peraturan ialah 94%.”
- **Putuskan:** “Apakah tindakan yang sebenarnya akan diambil?”
