...
> **© Ян Фріске / SonnerStudio, 2024–2026 — Все права защищены.**

**Nexus Gaja** является исключительной интеллектуальной собственностью **Яна Соннера**, работающего под управлением **SonnerStudio**.

Ян Фріске — единственный создатель, архитектор и владелец Nexus Gaja, включая все концепции, архитектуру, модели предметной области, фирменный стиль и соответствующую документацию.
...
Nexus Gaja и логотип Nexus Gaja являются товарными знаками Jan Friske. Несанкционированное использование названия или бренда запрещено.
