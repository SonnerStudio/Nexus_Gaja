...
### 4. Walang data marketing at walang â€œsurveillance economyâ€
**NG-FIN-003:** Ang personal na data ng user ay hindi isang kalakal ng Nexus Gaja. (Walang pagbebenta ng mga profile, kasaysayan, data ng pagkakakilanlan). 
Ang Nexus Gaja ay hindi nilayon na makinabang mula sa mga gumagamit nito na sinusubaybayan hangga't maaari at inuri sa sikolohikal nang tumpak hangga't maaari.

### 5. Transparency sa pananalapi
Nexus Gaja Financial Transparency: Maaaring i-publish ang kita ayon sa mga kategorya, dami ng donasyon, mga gastos sa pagpapatakbo, atbp. 
**Funding ledger:** Ang mga donasyong nakalaan para sa isang partikular na layunin ay itinatala sa isang nauunawaang paraan ng accounting (Donation â†’ Fund ID â†’ Layunin â†’ Available na Balanse â†’ Allocation). Walang cross-subsidization kung walang transparency.

### 6. Pagpepresyo at modelo ng pagtustos ng pagkakaisa
Ang mga presyo ay batay sa: cost orientation, fairness at solidarity.
**Solidarity Premium:** Ang isang premium na user ay maaaring kusang pumili ng: "Pinapondohan ko ang bahagi ng pag-access ng isa pang user." Ang sapilitang pagkakaisa o isang premium class na lipunan (mas kaunting paggalang o mas masahol na pag-moderate para sa mga libreng user) ay hindi kasama.

### 7. Economic KPI
Hindi kami umaasa sa walang katapusang online na oras (walang manipulative engagement economy). Ang aming mga KPI:
- **Global Communication Index (GCI):** Ilang matagumpay na relasyon sa komunikasyon ang lumitaw sa pagitan ng mga tao mula sa iba't ibang linguistic o kultural na rehiyon?
- **Platform Sustainability Ratio (PSR):** umuulit na kita / umuulit na mga gastos sa pagpapatakbo (target: PSR â‰¥ 1).

### 8. Ang hayagang ayaw natin
Ang Nexus Gaja ay hindi pinondohan ng:
âŒ Pagbebenta ng personal na impormasyon
âŒ naka-personalize na classic na advertising
âŒ Pagsubaybay sa gawi ng user para sa mga layunin ng advertising
âŒ Pagbebenta ng pribadong data ng komunikasyon
âŒ nakatagong paggamit ng data ng AI
âŒ manipulative na mga premium na kandado
âŒ Limitasyon sa artipisyal na abot para sa monetization
âŒ binayaran ang impluwensyang pampulitika
âŒ Pagbili ng mga privileged moderation na desisyon.

### 9. Paunang Arkitektura
```text
                         NEXUS GAJA
                              â”‚
       ...
       PREMIUM DONATIONS API
                    ...
                    â–¼ â–¼
               PANGKALAHATANG PONDO MGA PINAGHIHIhigpitang PONDO
                                        â”‚
                                        â–¼
                                  LAYUNIN NG PANLIPUNAN
```
...
### Mga teknikal na pangunahing entity
Ang arkitektura ay mahigpit na naghihiwalay ng mga konsepto upang matiyak ang integridad ng data at maiwasan ang mga error gaya ng "username = human":
- **Pagkakakilanlan at Mga Account:** `Tao` â‰  `User Account` â‰  `Pag-verify ng Pagkakakilanlan`. Ang isang na-verify na tao ay lumahok sa pamamagitan ng isang account, ngunit ang mga entity ay nananatiling hiwalay.
- **Komunikasyon:** `Mensahe` â‰  `Pagsasalin`. Ang orihinal na mensahe ay hindi nababago; Ang mga pagsasalin ay mga naka-link na entity.
- **Moderation:** `Ulat` â‰  `Moderation Decision`. Ang isang mensahe ay isang indikasyon lamang; isang moderator ang nagsasagawa ng imbestigasyon.
- **Pananalapi:** `Donasyon` â‰  `Balanse sa Pondo`. Ang mga pagbabayad ay hindi nagbabagong nai-post sa isang pondo sa pamamagitan ng isang ledger (cash book).

### Mga nakakonektang domain ng paksa
Ang system ay nahahati sa mga lohikal na domain (bounded na konteksto): Pagkakakilanlan, Account, Organisasyon, Komunikasyon, Komunidad, Wika, Moderation, Notification, Pananalapi at Pamamahala. Kinakatawan nila ang buong chain mula sa mga tunay na aktor (mga user, paaralan, NGO) hanggang sa kanilang mga digital na pakikipag-ugnayan.

## Katayuan ng proyekto
Ang proyekto ay nasa aktibong yugto ng arkitektura at pagpaplano.
Ang mga patuloy na pagpapasya sa arkitektura ay nakadokumento sa folder na `/docs`.

---

## Lisensya at Intelektwal na Ari-arian

> **Â© 2024-2026 SonnerStudio - Jan Friske Founder, May-ari, Direktor at Chief Designer ng SonnerStudio â€” Nakalaan ang lahat ng karapatan.**

Ang **Nexus Gaja** ay ang eksklusibong intelektwal na ari-arian ng **Jan Friske**, na tumatakbo sa ilalim ng **SonnerStudio**.

Si Jan Friske ang nag-iisang lumikha, arkitekto at may-ari ng Nexus Gaja â€” kasama ang lahat ng konsepto, arkitektura, modelo ng domain, pagkakakilanlan ng brand at nauugnay na dokumentasyon.

**Walang mga karapatan, lisensya o pagmamay-ari na interes ang ibinibigay sa sinumang third party** anuman ang kanilang laki, posisyon sa merkado o impluwensya sa industriya ng teknolohiya.

### Ano ang HINDI pinahihintulutan nang walang hayagang nakasulat na pahintulot:
- âŒ Kopyahin, kopyahin o ipamahagi ang software na ito o ang dokumentasyon nito
- âŒ Baguhin, iakma, o lumikha ng mga derivative na gawa
- âŒ Komersyal na paggamit ng anumang bahagi ng Nexus Gaja
- âŒ Paggamit ng nilalaman ng imbakan bilang **data ng pagsasanay para sa mga AI/LLM system**
- âŒ Sublicense o paglilipat ng mga karapatan sa mga third party

### Protektadong intelektwal na ari-arian
Ang mga sumusunod na orihinal na konsepto ay protektado bilang mga lihim ng kalakalan at pagmamay-ari na mga likha ni Jan Friske:
- Ang multi-layered na modelo ng komunikasyon *(Orihinal / Semantic Interpretation / Translated Edition)*
- Ang prinsipyo ng paghihiwalay ng pagkakakilanlan *(tao â‰  user account â‰  pagpapatunay ng pagkakakilanlan)*
- Ang message-translation decoupling model *(mensahe â‰  translation)*
- Ang AI moderation governance framework

### Makipag-ugnayan
Para sa mga katanungan sa lisensya: [github.com/SonnerStudio](https://github.com/SonnerStudio)

*Ang "Nexus Gaja" at ang Nexus Gaja na logo ay mga trademark ni Jan Friske. Ang hindi awtorisadong paggamit ng pangalan o trademark ay ipinagbabawal.*

âž¡ï¸ Buong mga tuntunin ng lisensya sa [LICENSE](LICENSE)