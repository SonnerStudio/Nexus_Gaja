...
### 4. Walang data marketing at walang “surveillance economy”
...
**Funding ledger:** Ang mga donasyong nakalaan para sa isang partikular na layunin ay itinatala sa isang nauunawaang paraan ng accounting (Donation → Fund ID → Layunin → Available na Balanse → Allocation). Walang cross-subsidization kung walang transparency.
...
- **Platform Sustainability Ratio (PSR):** umuulit na kita / umuulit na mga gastos sa pagpapatakbo (target: PSR ≥ 1).

### 8. Ang hayagang ayaw natin
Ang Nexus Gaja ay hindi pinondohan ng:
❌ Pagbebenta ng personal na impormasyon
❌ naka-personalize na classic na advertising
❌ Pagsubaybay sa gawi ng user para sa mga layunin ng advertising
❌ Pagbebenta ng pribadong data ng komunikasyon
❌ nakatagong paggamit ng data ng AI
❌ manipulative na mga premium na kandado
❌ Limitasyon sa artipisyal na abot para sa monetization
❌ binayaran ang impluwensyang pampulitika
❌ Pagbili ng mga privileged moderation na desisyon.
...
- **Pagkakakilanlan at Mga Account:** `Tao` ≠ `User Account` ≠ `Pag-verify ng Pagkakakilanlan`. Ang isang na-verify na tao ay lumahok sa pamamagitan ng isang account, ngunit ang mga entity ay nananatiling hiwalay.
- **Komunikasyon:** `Mensahe` ≠ `Pagsasalin`. Ang orihinal na mensahe ay hindi nababago; Ang mga pagsasalin ay mga naka-link na entity.
- **Moderation:** `Ulat` ≠ `Moderation Decision`. Ang isang mensahe ay isang indikasyon lamang; isang moderator ang nagsasagawa ng imbestigasyon.
- **Pananalapi:** `Donasyon` ≠ `Balanse sa Pondo`. Ang mga pagbabayad ay hindi nagbabagong nai-post sa isang pondo sa pamamagitan ng isang ledger (cash book).
...
> **© 2024-2026 SonnerStudio - Jan Friske Founder, May-ari, Direktor at Chief Designer ng SonnerStudio — Nakalaan ang lahat ng karapatan.**

Ang **Nexus Gaja** ay ang eksklusibong intelektwal na ari-arian ng **Jan Friske**, na tumatakbo sa ilalim ng **SonnerStudio**.

Si Jan Friske ang nag-iisang lumikha, arkitekto at may-ari ng Nexus Gaja — kasama ang lahat ng konsepto, arkitektura, modelo ng domain, pagkakakilanlan ng brand at nauugnay na dokumentasyon.
...
- ❌ Kopyahin, kopyahin o ipamahagi ang software na ito o ang dokumentasyon nito
- ❌ Baguhin, iakma, o lumikha ng mga derivative na gawa
- ❌ Komersyal na paggamit ng anumang bahagi ng Nexus Gaja
- ❌ Paggamit ng nilalaman ng imbakan bilang **data ng pagsasanay para sa mga AI/LLM system**
- ❌ Sublicense o paglilipat ng mga karapatan sa mga third party
...
- Ang prinsipyo ng paghihiwalay ng pagkakakilanlan *(tao ≠ user account ≠ pagpapatunay ng pagkakakilanlan)*
- Ang message-translation decoupling model *(mensahe ≠ translation)*
...
➡️ Buong mga tuntunin ng lisensya sa [LICENSE](LICENSE)